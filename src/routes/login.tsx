...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-6">
      <form
        onSubmit={submit}
        className="w-full max-w-sm space-y-4 rounded-2xl border border-border bg-card/40 p-8"
      >
        <Link
          to="/"
          className="block text-center text-xs uppercase tracking-widest text-[var(--accent-green)]"
        >
          SILENT ECHO
        </Link>
        ...
        <p className="text-center text-[10px] text-muted-foreground">Powered by SilentEcho</p>
      </form>
    </div>
  );
}
